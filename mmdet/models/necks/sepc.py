...
from mmdet.ops.dcn import sepc_conv
...
class SEPC(nn.Module):
    ...
    def __init__(self,
        ...
        self.lconv = sepc_conv(256, 256, kernel_size=3, padding=1, dilation=1, part_deform=lcconv_deform)
        self.cconv = sepc_conv(256, 256, kernel_size=3, padding=1, dilation=1, part_deform=lcconv_deform)
        self.relu = nn.ReLU()
        if self.iBN:
